	...
	public void eventHandler(RenderGameOverlayEvent event) {
		if (!event.isCancelable() && event.getType() == RenderGameOverlayEvent.ElementType.HELMET) {
			...
			if (true) {
				...
				}.getEnergyStored(new BlockPos((int) x, (int) y, (int) z))) + "", posX + -63, posY + -121, -16776961);
				Minecraft.getInstance().fontRenderer.drawString("" + (new Object() {
				...
				}.getFluidTankLevel(new BlockPos((int) x, (int) y, (int) z), 1)) + "", posX + -18, posY + -121, -65536);
				...
				Minecraft.getInstance().ingameGUI.blit(posX + 54, posY + -121, 0, 0, 16, 16, 16, 16);
