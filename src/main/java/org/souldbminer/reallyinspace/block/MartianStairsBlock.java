...
public class MartianStairsBlock extends RismodModElements.ModElement {
	@ObjectHolder("rismod:martian_stairs")
	public static final Block block = null;
	public MartianStairsBlock(RismodModElements instance) {
		super(instance, 7);
	}
