...
import org.souldbminer.reallyinspace.procedures.EnergyfaneinputProcedure;
...
public class BatteryBlock extends RisModElements.ModElement {
	@ObjectHolder("ris:battery")
	public static final Block block = null;
	@ObjectHolder("ris:battery")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public BatteryBlock(RisModElements instance) {
		super(instance, 204);
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				EnergyfaneinputProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, this.tickRate(world));
		}
