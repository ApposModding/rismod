...
public class MartianFenceBlock extends RismodModElements.ModElement {
	@ObjectHolder("rismod:martian_fence")
	public static final Block block = null;
	public MartianFenceBlock(RismodModElements instance) {
		super(instance, 9);
	}
