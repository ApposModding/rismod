...
public class GalaxiumSwordItem extends RismodModElements.ModElement {
	@ObjectHolder("rismod:galaxium_sword")
	public static final Item block = null;
	public GalaxiumSwordItem(RismodModElements instance) {
		super(instance, 31);
	}
