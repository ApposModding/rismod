...
import org.souldbminer.reallyinspace.procedures.ItemConverterProcedure;
...
public class ItemFixerItem extends RisModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(RISItemGroup.tab).maxStackSize(64).rarity(Rarity.EPIC));
