...
public class GalaxiumShovelItem extends RismodModElements.ModElement {
	@ObjectHolder("rismod:galaxium_shovel")
	public static final Item block = null;
	public GalaxiumShovelItem(RismodModElements instance) {
		super(instance, 32);
	}
